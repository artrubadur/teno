...
class OverlayForegroundService : Service(), KoinComponent {
    ...
    companion object {
        const val ACTION_START = "com.artrubadur.tonemo.overlay.START"
        const val ACTION_INPUT = "com.artrubadur.tonemo.overlay.INPUT"
        const val ACTION_STOP = "com.artrubadur.tonemo.overlay.STOP"
        const val ACTION_LAUNCH = "com.artrubadur.tonemo.overlay.LAUNCH"
        const val ACTION_TERMINATE = "com.artrubadur.tonemo.overlay.TERMINATE"
        const val ACTION_SHUTDOWN = "com.artrubadur.tonemo.overlay.SHUTDOWN"
